...
一番最初に勉強する言語は**Python**です。AIなどの研究分野でよく使われる言語で最近ではよく使われているので勉強しておいて損はありません。実際に最も有名な言語と言われています。[^note1]
...
Pythonは私がある意味で嫌いである意味で好きな言語です。また、私が一番初めに学んだ言語でもあります。安心してください。Pythonの基本はとても簡単です。
...
## Hello World
では`Hello World`を行いましょう。`Hello World`とは何ですか？`Hello World`はプログラマがその言語がきちんと動作することを確認するためにしばしばする行為です。具体的には単に`Hello World`とだけ出力するプログラムを動かすことです。
...
これからあなたはバリバリプログラムを書いていくわけなのでたくさんのエラーに遭遇する可能性が高いです。そうなる前に一般的にエラーに対してどのように対処すればいいか体系的にまとめておきましょう。
